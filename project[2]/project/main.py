...
print("Druva")
# Save the model
model_directory = r"C:\Users\DRUVA KUMAR\OneDrive\Desktop\MajorProject\tf_model"  # Using raw string (r"") to handle backslashes
print(f"Saving the model to {model_directory}...")
